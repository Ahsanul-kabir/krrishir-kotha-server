...
client.connect(err => {
    const orderCollection = client.db("krrishirKotha").collection("orders");
    const reviewCollection = client.db("krrishirKotha").collection("reviews");
    const serviceCollection = client.db("krrishirKotha").collection("services");
    const adminCollection = client.db("krrishirKotha").collection("admins");
